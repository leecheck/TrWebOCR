    ...
    <a-row>
      ...
      >
        <div class="right-wrapper">
          ...
          <div
            class="ocr-text"
            :hidden="hiddenOcrText"
          >
            <OCRTable :data="tableData"></OCRTable>
          </div>
        </div>
      </a-col>
    </a-row>
...
import OCRTable from "../components/OCRTable.vue";
    ...
    handleUpload() {
      ...
      axios({
        ...
        .then(function (response) {
          ...
          _this.$data.tableData = response.data["data"]["raw_out"];
